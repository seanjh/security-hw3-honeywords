...
from genp3 import db_count, generate_sweetwords,choose_rockyou,generate_sweetword_sets,rock_you_db
...
def main():
    ...
    sweets = generate_sweetword_sets(num, passwords,rockyou_most_common,db_count(rockyou_most_common))
